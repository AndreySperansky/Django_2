...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ['127.0.0.1']   # Для продвинутой аутентификации через соцсеть
...
# ********************************************************************************************************
# # Продвинутая аутентификация пользователей через соцальную сеть с автозаполнением профиля пользователя
# ********************************************************************************************************

LOGIN_ERROR_URL = '/'
# проброс на главную страницу в случае ошибки (можно сделать отдельную страницу)
